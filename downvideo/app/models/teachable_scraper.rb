...
class TeachableScraper
  ...
  LOGIN_URL = "https://sso.teachable.com/secure/279132/users/sign_in?clean_login=true&reset_purchase_session=1"
  USER = "perhuman@gmail.com"
  PASS = "0966668166"
...
#
# class GetVideoUrl
#   regex = %r{.*(https://embed-ssl.wistia.com/deliveries/.*\.jpg+)}
#
#   def find_url(html)
#     html.match(regex)[1].gsub('jpg', 'mp4')
#   end
# end
